...
if __name__ == "__main__":
    ...
    train_samples = read_json('clean_conversations_train.json')
    ...
    dev_samples = read_json('clean_conversations_val.json')
    ...
    if trainer.eval_log:
        ...
        print(
            f"min={min(eval_losses):.4f}, max={max(eval_losses):.4f}, final={eval_losses[-1]:.4f}")
